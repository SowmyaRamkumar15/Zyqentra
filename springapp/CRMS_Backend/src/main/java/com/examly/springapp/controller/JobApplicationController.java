...
public class JobApplicationController {
    ...
    // CREATE
    @PostMapping
    public ResponseEntity<?> createJobApplication(@RequestBody JobApplication jobApplication) {
        if (jobApplication == null) {
            return ResponseEntity.badRequest().body("Job application data is missing.");
        }
        try {
