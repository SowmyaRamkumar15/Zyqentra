  ...
  return (
    <div className="animate-fade-in">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h2 style={{ fontSize: '1.75rem' }}>Job Openings</h2>
          <p style={{ color: 'var(--text-muted)' }}>Manage and publish career opportunities for candidates.</p>
        </div>
        <button 
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '2.5rem' }}>
                ...
                <textarea 
                  ...
                  style={{ width: '100%', padding: '1rem', borderRadius: 'var(--radius)', border: '1px solid var(--border)', outline: 'none', background: 'var(--background)', color: 'var(--text-main)', resize: 'vertical' }}
