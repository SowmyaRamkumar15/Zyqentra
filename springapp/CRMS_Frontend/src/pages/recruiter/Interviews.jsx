  ...
  return (
    <div className="animate-fade-in">
      <div style={{ marginBottom: '2.5rem' }}>
        <h2 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Interviews & Feedback</h2>
        <p style={{ color: 'var(--text-muted)' }}>Review interview performance feedback for candidates.</p>
      </div>
                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid var(--border)', paddingTop: '1rem' }}>
                    <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                      Provided by: <span style={{ fontWeight: 600 }}>{f.user?.username || 'Recruiter'}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
